...
_initBootLoaderDataSegments_:
    ...
    mov ax , 0x0000 ; Set ax register to zero as only register to register operations allowed for loading section selector registers 
    mov ds , ax
    mov es , ax
    mov ss , ax
    mov sp , 0x7c00 ; load stack pointer to start with this address as the beggining point 
