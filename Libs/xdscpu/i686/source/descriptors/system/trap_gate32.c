#include "trap_gate32.h"

#define TRAP_GATE32_TYPE    ((uint32_t) 0x00000E00)
...
x86_32_err_type X86_32_CALL x86_32_trap_gate32_set(struct x86_32_trap_gate32* dest , const struct _x86_32_descriptor* src){
    ...
    if ( (src->dword2 & TRAP_GATE32_TYPE) != TRAP_GATE32_TYPE ){
    ...
    x86_32_selector_get(&dest->sel , &ssel); // take it as struct selector to the struct trap gate32 descriptor 
